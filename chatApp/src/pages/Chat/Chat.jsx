...
const Chat = () => {
    ...
    return (
      <div className={styles.chatContainer}>
        <div style={{ width: "750px", height: "500px", margin: "0 auto", padding: "2rem", textAlign: "center", }}>
          <MainContainer style={{ position: "relative", }}>
            {/* Move the chatContainer to the bottom */}
            <div className='chatContainer' style={{ height: "400px", overflowY: "auto", position: "absolute", bottom: "90px", left: 0, right: 0, }}>
              <ChatContainer>
                <MessageList
